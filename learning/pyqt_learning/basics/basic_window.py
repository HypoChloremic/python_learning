...
# Seemingly, to create applications using pyqt5
# we require to also create a class, that we then run in turn
# Furthermore, this class inherits from
...
class Window(QMainWindow): 
    ...
    def UiComponents(self): 
        ...
        # This is interesting, that we nest the method inside the 
        # component method. 
        def do_something(): 
